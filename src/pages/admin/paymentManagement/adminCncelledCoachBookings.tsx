...
const AdminCanceledCoachBookings = (props: any) => {
  ...
  //           arcadeBooking.booking_type === "coach"
  //       );
      ...
      <Spin spinning={loading}>
        ...
        <Row>
          <Col style={{ color: "#0E458E" }}>
            <h2>Cancelled By Admin - Coach Bookings</h2>
          </Col>
        </Row>
        <Row>
          <Col span={24}>
...
export default AdminCanceledCoachBookings;
